  ...
  const contactInfo = [
    {
      ...
      label: "Email",
      value: "dinithp132@gmail.com",
      href: "mailto:dinithp132@gmail.com"
    },
    {
    ...
    },
    {
      ...
      label: "LinkedIn",
      value: "linkedin.com/in/dinith-priyankara",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                ...
                and connecting with fellow developers. Whether you have a project in mind, 
            ...
            <div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 text-sm">
                ...
                AI/ML, and embedded systems. Let's build something amazing together!
              </p>
            </div>
          </motion.div>
          ...
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full flex items-center justify-center gap-2 px-8 py-4 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition-colors"
              >
        ...
        >
          <p className="text-gray-600 dark:text-gray-300">
            © 2024 Dinith Priyankara. Built with React, TypeScript, and Tailwind CSS.
          </p>
        </motion.div>
      </div>
    </section>
